...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class StripAdBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.mipmap.custom_error_icon)).into(stripAdImage);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder  {
        ...
        private void setGridProductLayout(final List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color) {
            ...
            for (int x = 0; x < 4; x++) {
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage()).apply(new RequestOptions().placeholder(R.mipmap.custom_error_icon)).into(productImage);
