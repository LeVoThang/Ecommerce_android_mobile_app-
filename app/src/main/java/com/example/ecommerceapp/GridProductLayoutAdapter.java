...
public class GridProductLayoutAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            Glide.with(parent.getContext()).load(horizontalProductScrollModelList.get(position).getProductImage()).apply(new RequestOptions().placeholder(R.mipmap.custom_error_icon)).into(productImage);
            productTitle.setText("Rs."+horizontalProductScrollModelList.get(position).getProductTitle()+"/-");
