...
public class SliderAdapter extends PagerAdapter {
    ...
    public SliderAdapter(List<SliderModel> sliderModelsList){
        this.sliderModelList = sliderModelsList;
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        Glide.with(container.getContext()).load(sliderModelList.get(position).getBanner()).apply(new RequestOptions().placeholder(R.mipmap.custom_error_icon)).into(banner);
